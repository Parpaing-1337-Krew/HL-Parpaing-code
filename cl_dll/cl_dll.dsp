...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib winmm.lib ../utils/vgui/lib/win32_vc6/vgui.lib wsock32.lib fmodvc.lib /nologo /subsystem:windows /dll /map /machine:I386 /out:".\Release\client.dll"
...
"copy $(OutDir)\client.dll c:\jeux\half-life\hl-parpaing\cl_dlls" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(OutDir)\client.dll c:\jeux\half-life\hl-parpaing\cl_dlls
...
# ADD LINK32 oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib winmm.lib ../utils/vgui/lib/win32_vc6/vgui.lib wsock32.lib fmodvc.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:".\Debug\client.dll"
# SUBTRACT LINK32 /pdb:none
# Begin Custom Build
OutDir=.\Debug
...
SOURCE=..\dlls\parpaing.cpp
# End Source File
# Begin Source File

SOURCE=..\dlls\sifflet2.cpp
# End Source File
# Begin Source File
