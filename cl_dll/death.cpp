...
#define DEATHNOTICE_TOP		YRES(60)
...
float *GetClientColor( int clientIndex )
{
	...
	/*	if ( !strcmp( gViewPort->GetTeamName(g_PlayerExtraInfo[clientIndex].teamnumber), "Macon[51]" ) )
		return g_ColorBlue;
		if ( !strcmp( gViewPort->GetTeamName(g_PlayerExtraInfo[clientIndex].teamnumber), "Macon[Ricard]" ) )
		return g_ColorRed;
		if ( !strcmp( gViewPort->GetTeamName(g_PlayerExtraInfo[clientIndex].teamnumber), "Inspecteur" ) )
		return g_ColorGreen;
		if ( !strcmp( gViewPort->GetTeamName(g_PlayerExtraInfo[clientIndex].teamnumber), "Spectacteur" ) )
