...
void ScorePanel::FillGrid()
{
	...
	for(int row=0; row < NUM_ROWS; row++)
	{
		...
		for(int col=0; col < NUM_COLUMNS; col++)
		{
			...
			/*	pLabel->setFgColor(GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),0),
									GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),1),
									GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),2),
									0 );*/
			...
			/*	pGridRow->SetRowUnderline(	0,
											true,
											YRES(3),
											GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),0),
											GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),1),
											GetTeamColor(gViewPort->GetTeamName(team_info->teamnumber),2),
											0 );*/
			...
			/*	pLabel->setFgColor(	GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),0),
									GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),1),
									GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),2),
									0 );*/
			...
			/*		pLabel->setBgColor(	GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),0),
									GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),1),
									GetTeamColor(gViewPort->GetTeamName(g_PlayerExtraInfo[ m_iSortedRows[row] ].teamnumber),2),
										196 );*/
