...
//
// $Workfile:     $
// $Date: 2003/04/28 20:46:32 $
//
//-----------------------------------------------------------------------------
// $Log: vgui_infos.cpp,v $
// Revision 1.1  2003/04/28 20:46:32  madfab
// *** empty log message ***
//
//
// $NoKeywords: $
...
SBColumnInfo2 g_ColumnInfo[NUM_COLUMNS] =
{
...
//-----------------------------------------------------------------------------
// InfosPanel::HitTestPanel.
//-----------------------------------------------------------------------------

void InfosPanel::HitTestPanel::internalMousePressed(MouseCode code)
{
...
//-----------------------------------------------------------------------------
InfosPanel::InfosPanel(int x,int y,int wide,int tall) : Panel(x,y,wide,tall)
{
...
//-----------------------------------------------------------------------------
void InfosPanel::Initialize( void )
{
...
//-----------------------------------------------------------------------------
void InfosPanel::SortPlayers( int iTeam, char *team )
{
...
//-----------------------------------------------------------------------------
void InfosPanel::DeathMsg( int killer, int victim )
{
...
void InfosPanel::mousePressed(MouseCode code, Panel* panel)
{
...
void InfosPanel::cursorMoved(int x, int y, Panel *panel)
{
	if (GetClientVoiceMgr()->IsInSquelchMode())
	{
...
//			col - 
//-----------------------------------------------------------------------------
void InfosPanel::MouseOverCell(int row, int col)
{
