...
# ADD LINK32 ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /map /debug /machine:I386 /def:".\hl.def"
...
"copy $(OutDir)\hl.dll c:\jeux\half-life\hl-parpaing\dlls" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(OutDir)\hl.dll c:\jeux\half-life\hl-parpaing\dlls
...
# ADD CPP /nologo /G5 /MD /W3 /Gm /ZI /Od /I "..\dlls" /I "..\engine" /I "..\common" /I "..\game_shared" /I "..\pm_shared" /I "..\\" /I "../mysql/include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "QUIVER" /D "VOXEL" /D "QUAKE2" /D "VALVE_DLL" /D "CLIENT_WEAPONS" /FR /YX /FD /c
...
# ADD LINK32 user32.lib advapi32.lib shell32.lib ws2_32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /def:".\hl.def" /implib:".\Debug\hl.lib"
# SUBTRACT LINK32 /pdb:none
# Begin Custom Build
OutDir=.\debughl
...
SOURCE=.\defuse_the_parpaing.cpp
# End Source File
# Begin Source File
