...
void CMur::Use(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
  ...
  if ((pPlayer->m_pActiveItem) && ( pPlayer->m_pActiveItem->m_iId == 16) && pPlayer->m_iTeam == team)
	...
	{
	case 1:
	  UTIL_MessageEffect(pPlayer,msg,1,-1,-1,0, v1,255, v2,0,1,1,1,0);
	  break;
	case 2:
	  UTIL_MessageEffect(pPlayer,msg,1,-1,-1,0,v3,255,v2,0,1,1,1,0);
	  break;
	}
    }
  ...
  if (avancement < 100)
      ...
      for (int i = 1;i<= gpGlobals->maxClients; i++)
	{
	  ...
	  if ( pPlayer2 )
		...
		{
		case 1:
		  UTIL_MessageEffect(pPlayer2,msg,1,-1,-1,0,v1,255,v2,0,1,1,1,0);
		  break;
		case 2:
		  UTIL_MessageEffect(pPlayer2,msg,1,-1,-1,0,v3,255,v2,0,1,1,1,0);
		  break;
		}
	    }
	}
