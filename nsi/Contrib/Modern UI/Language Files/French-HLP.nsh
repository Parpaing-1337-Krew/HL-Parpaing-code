...
!insertmacro MUI_LANGUAGEFILE_BEGIN "FRENCH"
  ...
  !define MUI_TEXT_DIRECTORY_SUBTITLE "Choisissez le dossier dans lequel installer $(^Name). Normalement autodétecté. Doit contenir hl.exe !"
  !define MUI_TEXT_INSTALLING_TITLE "Installation en cours"
  !define MUI_TEXT_INSTALLING_SUBTITLE "Veuillez patienter pendant qu'$(^Name) est en train d'être installé."
  ...
  !define MUI_TEXT_FINISH_INFO_REBOOT "Votre ordinateur doit être redémarré afin de compléter l'installation d'$(^Name). Souhaitez-vous redémarrer maintenant ?"
  ...
  !define MUI_TEXT_ABORTWARNING "Êtes-vous sûr de vouloir quitter l'installation d'$(^Name) ?"
  ...
  !define MUI_UNINNERTEXT_LICENSE_BOTTOM_CHECKBOX "Si vous acceptez les termes de la licence utilisateur, cochez la case ci-dessous. Vous devez accepter la licence utilisateur pour désintaller $(^Name)."
  ...
  !define MUI_UNTEXT_UNINSTALLING_SUBTITLE "Veuillez patienter pendant qu'$(^Name) est en train d'être supprimé de votre ordinateur."

  !define MUI_UNTEXT_COMPONENTS_TITLE "Choisissez les composants"
  !define MUI_UNTEXT_COMPONENTS_SUBTITLE "Cochez les composants d'$(^Name) que vous souhaitez désinstaller."
